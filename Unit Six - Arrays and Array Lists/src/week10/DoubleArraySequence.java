...
public class DoubleArraySequence {
    ...
    * @postcondition If the current element was already the end element of thisvb         
   ...
   public void advance(){
      if (!isCurrent()){
         throw new IllegalStateException("No Current Element. Advance Cannot be Called.");
      }
      currentIndex++;
   }
   ...
   public static DoubleArraySequence catenation(DoubleArraySequence s1, DoubleArraySequence s2) {
      if(s1 == null || s2 == null){
         throw new NullPointerException("s1 or s2 are null"); 
      }
      //s1.trimToSize();
      //s2.trimToSize();
